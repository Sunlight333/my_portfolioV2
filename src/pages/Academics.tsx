  ...
  const education = [
    {
      ...
      cgpa: "Completed",
      details: [
        "Specialized in Software System Development",
        "Key courses include Software Engineering, Database Systems, Web Development",
        "Foundation in enterprise software development and modern programming practices"
      ]
    }
  ];
      ...
      <section className="pt-32 pb-16">
        <div className="container mx-auto px-4">
          ...
          <div className="mb-24">
            ...
            <div className="flex grid grid-cols md:grid-cols lg:grid-cols gap-8">
