  ...
  const featuredProjects = [
    {
      ...
      description: "Comprehensive order management platform with payment integration, inventory sync, and reporting.",
    ...
    },
    {
      ...
      description: "Integrated LLMs for customer support and product discovery with multiple AI models.",
    ...
    },
    {
      ...
      description: "Complete SaaS platform with subscription billing, tenant isolation, and admin console.",
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="max-w-3xl mx-auto text-muted-foreground">
                I'm a Senior Full Stack Engineer with 9+ years of experience. Specializing in SaaS platforms, AI/LLM integration, and payment workflows for enterprise solutions.
            </p>
          </motion.div>
