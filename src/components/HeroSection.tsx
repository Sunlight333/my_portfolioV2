...
const phrases = [
  ...
  "SaaS Platform Specialist",
  "AI/LLM Integration Expert",
  "Payment Workflow Developer"
];
      ...
      <div className="container mx-auto px-4 z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            >
              Over 9 years of experience in secure, scalable, and high-performance web applications. 
              Specializing in SaaS platforms, AI/LLM integration, and payment workflows. 
              Passionate about delivering solutions that balance technical excellence and business growth.
            </motion.p>
